...
#+begin_export html
<a href="https://github.com/kmehtab/emacs-config/"
...
**** MacOs
deleting files or folders in emacs will go to trash
#+begin_src emacs-lisp
        ...
        (list
         ...
         (make-mu4e-context
          ...
          :match-func
            (lambda (msg)
              (when msg
                (string-prefix-p "/kmehtab20" (mu4e-message-field msg :maildir))))
          :vars '((user-mail-address . "kmehtab20@gmail.com")
                  (user-full-name    . "Mehtab Khan")
                  (mu4e-drafts-folder  . "/kmehtab20/[Gmail]/Drafts")
                  (mu4e-sent-folder  . "/kmehtab20/[Gmail]/Sent Mail")
                  (mu4e-refile-folder  . "/kmehtab20/[Gmail]/All Mail")
                  (mu4e-trash-folder  . "/kmehtab20/[Gmail]/Trash")))
         ...
         (make-mu4e-context
          ...
          :match-func
            (lambda (msg)
              (when msg
                (string-prefix-p "/kmehtab637" (mu4e-message-field msg :maildir))))
          :vars '((user-mail-address . "kmehtab637.ma@gmail.com")
                  (user-full-name    . "Mehtab khan")
                  (mu4e-drafts-folder  . "/kmehtab637/[Gmail]/Drafts")
                  (mu4e-sent-folder  . "/kmehtab637/[Gmail]/Sent Mail")
                  (mu4e-refile-folder  . "/kmehtab637/[Gmail]/All Mail")
                  (mu4e-trash-folder  . "/kmehtab637/[Gmail]/Trash")))))
...
#+begin_src emacs-lisp
(defvar mu4e-from-name "Mehtab Khan"
